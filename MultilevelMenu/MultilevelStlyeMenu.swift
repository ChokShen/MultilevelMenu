...
public class MultilevelStlyeMenu: UIView {
    ...
    func creatDisplayButton(_ name: String?) {
        ...
        let buttonW_Text = text?.boundingRect(with: CGSize(width: CGFloat(MAXFLOAT), height: buttonH), options: .usesLineFragmentOrigin, attributes: [NSFontAttributeName: UIFont.systemFont(ofSize: 16)], context: nil).width
